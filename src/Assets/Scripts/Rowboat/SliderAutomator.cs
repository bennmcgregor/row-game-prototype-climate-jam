...
public class SliderAutomator : MonoBehaviour
{
    [SerializeField] private Slider _slider;
    [SerializeField] private float _velocity = 1f;
    [SerializeField] private SliderPlayer _sliderPlayer;
    ...
    private bool IsDecreasing => _velocity < 0;
    private float _playerMostRecentCatchPosition;
    private float _playerSecondMostRecentCatchPosition;
    private float _playerMostRecentFinishPosition;
    private float _playerSecondMostRecentFinishPosition;
    ...
    private void Awake()
    {
        ...
        _sliderPlayer.OnCatchPositionUpdated += OnCatchPositionUpdated;
        _sliderPlayer.OnFinishPositionUpdated += OnFinishPositionUpdated;
    ...
    private void Start()
    {
        _playerMostRecentCatchPosition = _sliderPlayer.CatchPosition;
        _playerMostRecentFinishPosition = _sliderPlayer.FinishPosition;
        
        // TODO: may not be correct
        _playerSecondMostRecentCatchPosition = _sliderPlayer.CatchPosition;
        _playerSecondMostRecentFinishPosition = _sliderPlayer.FinishPosition;
    ...
    {
        _playerSecondMostRecentCatchPosition = _playerMostRecentCatchPosition;
    ...
    {
        _playerSecondMostRecentFinishPosition = _playerMostRecentFinishPosition;
    ...
    private void UpdateVelocityForRecovery()
    {
        ...
        float predictedTimeToCatchForPlayer = (_playerMostRecentCatchPosition 
            - _sliderPlayer.GetSliderPosition()) / _sliderPlayer.CurrentSpeed;
        ...
        else // player has passed predicted catch position
        {
            ...
            _velocity = _sliderPlayer.CurrentSpeed;
        }
    }
    ...
    private void UpdateVelocityForDrive()
    {
        ...
        {
            // just keep following the player
            _velocity = -1 * _sliderPlayer.CurrentSpeed;
        }
    }
    ...
    private IEnumerator FollowPlayer()
    {
        while (true)
        {
            ...
            // Assert.IsTrue(_sliderPlayer.CurrentState == RowingState.RECOVERY);
            // use default velocity
            do
            {
                // the AI's position is behind the player
                if (_sliderPlayer.GetSliderPosition() >= GetSliderPosition())
                {
            ...
            // Assert.IsTrue(_sliderPlayer.CurrentState == RowingState.DRIVE);
            ...
            else // player has passed predicted finish position
            {
                ...
                predictedTimeToFinishForPlayer = _sliderPlayer.GetSliderPosition() / _sliderPlayer.CurrentSpeed;
                ...
                do { // the AI is in recovery, player is in drive
                    ...
                    if (predictedTimeToFinishForPlayer < 0) {
                        predictedTimeFromFinishToCatch = (_playerMostRecentCatchPosition - 
                            _playerMostRecentFinishPosition) / _sliderPlayer.CurrentSpeed; // TODO: change this CurrentSpeed to the predicted recovery speed
                    }
                    else // player has passed predicted finish position
                    {
                        predictedTimeFromFinishToCatch = (_playerMostRecentCatchPosition -
                            _sliderPlayer.GetSliderPosition()) / _sliderPlayer.CurrentSpeed; // TODO: change this CurrentSpeed to the predicted recovery speed
                    }
            ...
            do
            {
                ...
                if (GetSliderPosition() >= _sliderPlayer.GetSliderPosition())
                {
            ...
            else // player has passed predicted finish position
            {
                ...
                predictedTimeToCatchForPlayer = (100 - _sliderPlayer.GetSliderPosition()) / _sliderPlayer.CurrentSpeed;
                ...
                do { // the AI is in drive, player is in recovery
                    ...
                    if (predictedTimeToCatchForPlayer > 0) {
                        predictedTimeFromCatchToFinish = (_playerMostRecentCatchPosition - 
                            _playerMostRecentFinishPosition) / _sliderPlayer.CurrentSpeed; // TODO: change this CurrentSpeed to the predicted drive speed
                    }
                    else // player has passed predicted catch position
                    {
                        predictedTimeFromCatchToFinish = (_sliderPlayer.GetSliderPosition() -
                            _playerMostRecentFinishPosition) / _sliderPlayer.CurrentSpeed; // TODO: change this CurrentSpeed to the predicted drive speed
                    }
